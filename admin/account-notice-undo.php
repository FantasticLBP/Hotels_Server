						...
						<li class="purple">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-important"><?php
										require_once('../controller/notice.php');
										$test=new notice();
										$test->query('projector');
									?></span>
							</a>
								...
								<li>
									<a href="#">
                                        ...
                                        <?php
											...
											$sql="select * from projector where id=3 order by regtime desc";
...
<ul class="nav nav-list">
	...
	$stmt->execute();
	 ...
	 foreach($allrows as $row){
		...
		echo '<a  class="btn btn-xs btn-info"  role="button" href="../controller/delete.php?id='.$row['id'].'" onclick="javascript:return p_del()"><i class="icon-remove bigger-120">删 除</i></a>';
		echo '<a  class="btn btn-xs btn-info"  role="button" href="edit.php?id='.$row['id'].'" ><i class="icon-edit bigger-120">编辑</i></a>';
		...
		echo '<li>';
		echo '<a href="#" class="tooltip-info" data-rel="tooltip" title="View">';
		echo '<span class="blue">';
		echo '<i class="icon-refresh bigger-120"></i>';
		echo '</span>';
		echo '</a>';
		echo '</li>';
		echo '<li>';
		echo '<a href="#" class="tooltip-success" data-rel="tooltip" title="Edit">';
