    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li ><a href="applycheck.php"> <i
                        class="icon-eye-open"></i> <span class="menu-text"> 笼位审核</span>
                </a></li>



                <li class="active"><a href="MDcheck.php" class="dropdown-toggle"> <i
                            class="icon-edit"></i> <span class="menu-text"> 指令校验 </span> <b
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        $sql2="select * from instruction where state = 0 order by time asc";
                                        ...
                                        foreach($allrows2 as $row2):
                                            ...
                                            <tr><td class="center">
                                                ...
                                                <td class="center hidden-480"><?php echo  $row2['time']; ?></td>
                                                <td class="center" hidden="hidden">'.$row['mobilephone'].'</td>
                                                <td class="center">
                                                    <div
                                                        class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a href="../controller/MDcheckhand.php?re=1&insid=<?php echo $row2['insid']; ?>"
                                                           role="button" class="green" data-toggle="modal"><button
                                                                type="button"
                                                                class="btn btn-info btn btn-default btn-sm">通过</button></a>
                                                        <a href="../controller/MDcheckhand.php?re=2&insid=<?php echo $row2['insid']; ?>"
                                                           role="button" class="blue"><button type="button"
                                                                                              class="btn btn-warning btn btn-default btn-sm">拒绝</button></a>
                                                    </div>
                                                            ...
                                                            <ul
                                                                ...
                                                                <li><a href="#" class="tooltip-info"
                                                                       data-rel="tooltip" title="View"> <span
                                                                            class="blue"> <i
                                                                                class="icon-refresh bigger-120"></i>
																		</span>
                                                                    </a></li>
