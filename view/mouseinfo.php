	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				...
				<li  class="active">
					<a href="mouseinfo.php" class="dropdown-toggle">
						<i class="icon-list"></i>
								...
								<div class="table-responsive">
									<table id="sample-table-2" class="table table-striped table-bordered table-hover">
										...
										foreach($allrows as $row){
											...
											echo '<td class="hidden-480 center">'.$usertype.'</td>';
											echo '<td class="center">'.$row['mobilephone'].'</td>';
											echo '<td class="center">'.$row['projectername'].'</td>';
											echo '<td class="center">';
											...
											echo '<a  class="btn btn-xs btn-info"  role="button" href="edit.php?username='.$row['username'].'" ><i class="icon-edit bigger-120">编辑</i></a>';
											...
											echo '<li>';
											echo '<a  class="btn btn-xs btn-info"  role="button" href="../controller/delete.php?username='.$row['username'].'" onclick="javascript:return p_del()"><i class="icon-remove bigger-120">删</i></a>';
											echo '</li>';
											echo '<li>';
											echo '<a  class="btn btn-xs btn-info"  role="button" href="edit.php?username='.$row['username'].'" ><i class="icon-edit bigger-120">编</i></a>';
