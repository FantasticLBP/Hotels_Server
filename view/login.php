...
<!--登陆表单-->
	...
	<input type="password" id="password" name="password" class="form-control" placeholder="密码" required="required"/>
														...
														<div class="clearfix">
														<label class="inline">
															<input type="checkbox" class="ace" id="rememberUser" name="rememberUser"/>
															<span class="lbl"> 记住</span>
														</label>
  <input type="submit" value="登录"  onClick="check();"   class="width-35 pull-right btn btn-sm btn-primary"/>
