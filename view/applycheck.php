                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        $sql2="select * from cageapply  where  ispost = 1 and status = 0 order by time  asc";
                                        ...
                                        foreach($allrows2 as $row2):
                                            ...
                                            ?>
                                            <tr><td class="center"><label> <input
                                                            type="checkbox" class="ace" /> <span class="lbl"></span></label></td>
                                                <td class="center"><?php echo $row2['cageid']; ?></td>
                                                <td class="hidden-480 center"> <?php
                                                   echo $row2['username'];
                                                    ?>
                                                    </td>
                                                <td class=" center"><?php echo $row2['number']; ?></td>
                                                <td class="center hidden-480"><?php echo $row2['time']; ?></td>
                                                <td class="center hidden-480"><a href="applycheckmessage.php?id=<?php echo $row2['cageid']; ?>"><button
