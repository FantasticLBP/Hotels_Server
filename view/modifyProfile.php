                                ...
                                <div class="col-xs-12 col-sm-3 center">
                                    ...
                                    <div class="profile-contact-info">
                                        ...
                                        <div class="profile-social-links center">
                                            <a href="#" class="tooltip-info" title="" data-original-title="查看小鼠记录">
                                                <i class="middle   icon-search icon-2x blue"></i>
                                            </a>

                                            <a href="#" class="tooltip-error" title="" data-original-title="查看笼架">
                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
														<span class="editable" name="username" id="username"><?php
                                                            error_reporting(0);
                                                            ...
                                                            $usernamePass;
                                                            foreach($allrows as $row) {
                                                                $usernamePass=$row["username"];
                                                            }
                                                            $PdoMySQL=new PdoMySQL();
                                                            $row=$PdoMySQL->find($table,"username='{$usernamePass}'");
                                                            if($row['usertype']==1){
                                                                $usertype='科研人员';
										...
										<span  hidden="hidden" id="currentUsername"><?php $pdo=new PDO('mysql:host=localhost;dbname=db_pet','root','root');
                                            $sql="select * from sessionTab ";
                                            $stmt=$pdo->prepare($sql);
                                            $stmt->execute();
                                            $allrows = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="password" name="password"><?php  echo base64_decode($row['password']); ?></span>
                                            </div>
                                        </div>
