				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							新笼位申请 <small> <i class="icon-double-angle-right"></i>
								提交小鼠信息
								</small>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-12">
									...
									<form class="form-horizontal" role="form" name="form"
										  action="../controller/operationhand.php">

										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right"
												   for="form-field-1">指令</label>
											<div class="col-sm-9">
											<textarea type="text" id="txt" name="txt"
													  class="col-xs-10 col-sm-5" /></textarea>
											</div>
										</div>
										<input  hidden="hidden" id="mid" name="mid" class="hide" value="<?php echo $mid; ?>">
										<input  hidden="hidden"   id="cageid" name="cageid" class="hide" value="<?php echo $cageid;  ?>">
