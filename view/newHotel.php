    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/publishHotel.php" method="post" enctype="multipart/form-data" onsubmit="to validate()">
...
//                       alert("请填写酒店地址");
//                       return false;
//                   }else if($("#hasWifi").val() == "0"){
//                       alert("请选择wifi情况");
//                       return false;
//                   }
//                   else if($("#hasParking").val() == "0"){
//                       alert("请选择停车场情况");
//                       return false;
//                   }
//                   else if($("#hasPackage").val() == "0"){
//                       alert("请选择行李寄存情况");
//                       return false;
//                   }
//                   else if($("#hasMeeting").val() == "0"){
//                       alert("请选择会议室");
//                       return false;
