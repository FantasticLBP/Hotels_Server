									...
									<div class="table-responsive">
										<table id="sample-table-1"
											...
											<tr>
												...
												<th class="center">小鼠数量</th>
												<th class="center">申请时间</th>
												<th class="hidden-480 center">申请状态</th>
											...
											<tr>
												...
												$sql1="select * from cageapply  where  username =? and status=0";
												...
												<td class="center"><?php echo $row1['cageid'];  ?></td>
												<td class="hidden-480 center"><?php echo $row1['number'];  ?></td>
												...
												<td class="center">
													<div
														...
														<a href="applyAni.php?id=<?php echo $row1['cageid']; ?>"><button
																	class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120">查看</i>
															</button></a> <a
																href="../controller/deletecage.php?page=1&id=<?php echo $row1['cageid']; ?>"><button
																	class="btn btn-xs btn-error">
																<i class="icon-edit bigger-120">删除</i>
															</button></a> <a
																href="../controller/postcage.php?id=<?php echo $row1['cageid']; ?>"><button
																	class="btn btn-xs btn-warning">
																<i class="icon-edit bigger-120">提交</i>
															</button></a>
														</button>
													</div>
												</td>
											...
											<tr>
												<td colspan="6" class="center"><a
															href="../controller/addcage.php"><button type="button"
																									 class="btn btn-info btn btn-default btn-sm">添加申请</button></a></td>
											</tr>
