                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    $sql1="select * from mouseapply  where  cageid =? order by id  asc";
                                //select * from mouseapply where cageid =201509140008 order by id asc
                                    ...
                                    <tr>
                                        <td class="center"><label> <input type="radio"
                                                                          name="change" id="change" value="<?php echo $row1['mouseid']; ?>">
                                                <span class="lbl"></span></label></td>
                                        <td class="center"><?php echo $row1['mouseid']; ?><a href="#"></a></td>

                                        <td class="center" id="" name=""><?php echo $row1['id']; ?></td>
                                        <td class="center"><?php echo $row1['erbiao']; ?></td>
                                        <td class="hidden-480 center"><?php echo $row1['name']; ?></td>
                                        <td class="center"><?php echo $row1['breed']; ?></td>
                                        <td class="hidden-480 center"><?php echo $row1['gene']; ?></td>
                                        <td class="hidden-480 center"><?php echo $row1['furcolor']; ?></td>
                                    ...
                                    <input type="text" hidden="true" id="cageid" name=""
                                           value="<?php echo $cageid; ?>"></input>
                                    <input type="text" hidden="true" id="num" name=""
                                           value="<?php echo $i+1; ?>"></input>
                                    </tbody>
                                </table>
                        ...
                        <form class="form-horizontal" role="form" name="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" id="id" name="id"
                                           class="col-xs-10 col-sm-5" title="请顺序填写数字1~5" onblur="record()"  />
                                    <span class="help-inline col-xs-12 col-sm-7"> <span class="middle">单一笼盒最大饲养量为5只。</span>
										</span>

                                </div><span id="txtHint"></span><
                            </div>
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="erbiao" name="erbiao"
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <button class="btn btn-warning" type="button" id="applychange">
                            ...
                            <button class="btn btn-danger" type="reset" onClick="quit()">
                                <i class="icon-remove bigger-110"></i> 退出
                            </button>
                    ...
                    <script>
                        document.getElementById("applypost").onclick = function() {
                            ...
                            alert(selectObj.options(index).text);
                            var fur = null;

                            var temp1 = document
                                .getElementsByName("furcolor");
                            ...
                            if (document.getElementById("num").value > 5) {
                                ...
                                var data = "&cageid="
                                    ...
                                    + "&name="
                                    + document
                                        .getElementById("animalName").value
                                    + "&breed="
                    ...
                    <script>
                        document.getElementById("applychange").onclick = function() {
                            var val = null;
