	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				<li><a href="cageApply.php"> <i class="icon-edit"></i> <span
								class="menu-text"> 新笼位申请 </span>
					</a></li>

				<li><a href="main.php"> <i class="icon-search"></i> <span
								class="menu-text">已启用笼位查询 </span>
					</a></li>

				<li class="active"><a href="applyState.php"
									  class="dropdown-toggle"> <i class="icon-tasks"></i> <span
								class="menu-text"> 申请笼盒状态查询 </span> <b
			...
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					<li>
						...
						<a href="main.php.php">主页</a>
					</li>

					<li class="active">
						<a href="applyState.php.php">笼盒申请状态查询</a>
					</li>
				</ul><!-- .breadcrumb -->
			</div>
								...
								<div class="table-responsive">
									<table id="sample-table-2" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<th class="hidden-480 center">审核意见</th>
										</tr>
										</thead>
										...
										$sqlu="select cageapply.*,cage.cageid as fid from cageapply LEFT JOIN cage on cageapply.cageid=cage.formerid WHERE cageapply.username =?";
										$stmu=$pdou->prepare($sqlu);
										$stmu->execute(array($username));
										$allrowsu = $stmu->fetchAll(PDO::FETCH_ASSOC);
										...
										?>
											...
											<tr>
												...
												<td><?php echo $rowu['cageid'];  ?></td>
												<td class="hidden-480"><?php echo $rowu['number'];  ?></td>
												<td><?php
													...
													?></td>
												<td class="hidden-480"><?php echo $rowu['time'];  ?></td>
												<td><?php
													if( $rowu['fid']!=''){
														echo '<a href="main.php?longjiaid='.substr($rowu['fid'],0,6).'&pos='.substr($rowu['fid'],6,8).'">'.$rowu['fid'].'</a>';
													}else{
														echo '未分配';
													}

													?></td>
												<td class="hidden-480 center"><?php echo $rowu['message'];  ?></td>
