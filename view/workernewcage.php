		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				...
				if($temp=='1') {
					...
					echo '<li class="active"><a href="workernewcage.php"
				...
				<div class="row">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							if($temp=="1"){
								$sql1="select * from cage  where  cageid like '".$longjiaid."%'  and username in( select username from projector where projectername = (select projectername from projector where username = '".$_SESSION['username']."')) order by cageid  asc";
								...
								$sql1="select * from cage  where  cageid like '".$longjiaid."%' order by cageid  asc";
								$stmt1=$pdoFirst->prepare($sql1);
								$stmt1->execute();
								while($row1=$stmt1->fetch()){
								...
								if ($i == $k) {
									...
									<div class="col-xs-1  col-md-1 ">
										<img src="assets/images/gallery/changebefore.jpg" alt="小鼠"
											...
											<span style="font-size:15px;text-align:center;position: absolute; top: 0; left: 0; right:0; bottom:0;color:red"
												  id="<?php echo $row1['cageid']; ?>"
												  onClick="checkm(this)"><?php echo $bh . "-" . $row1['number']; ?></span>
					...
					<div class="modal-content">
						...
						<script>
							function search() {
								...
								window.location = "main.php?longjiaid=02010AA3"
